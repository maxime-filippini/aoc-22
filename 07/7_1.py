...
def compute(data):
    ...
    while curr_line_idx < len(lines):
        ...
        print(f"command: {curr_line}, {curr_line_idx=}")
        ...
        if curr_line.startswith("$ cd"):
            ...
            if path == "..":
                ...
                print(f"Going to parent {curr_line=}")
    ...
    return root_dir.get_total_below_x(threshold=100_000)


if __name__ == "__main__":
    assert compute(read_data("07", "test.txt")) == 95437
